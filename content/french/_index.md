...
feature:
  ...
  feature_item:
    ...
    - name : "holistique"
      ...
      content : "Au-delà de regrouper tous les essentiels du développement, du test, et de l'infrastructure,les combine pour fournir une expérience fluide et productive. Notre approche globale s'est développer pour repondre à vos besoins en proposant une expérience cohérente et intuitive."
    ...
    - name : "Cohérent"
      icon : "fas fa-atom"
      content : "Notre souhait est de vous permettre de développer vos produits en valorisant les plus values. Ainsi nous vous proposons une plateforme ayant une approche cohérente centrée sur le métier, votre différenciation."
